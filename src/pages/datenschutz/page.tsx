      ...
      <main className="max-w-5xl mx-auto px-6 pt-28 pb-16 md:pt-32 md:pb-24">
        ...
        >
          ...
          >
            ...
            <p className="mb-4">
              Unsere Website wird bei einem externen Dienstleister gehostet. Die personenbezogenen Daten, die auf dieser
              Website erfasst werden, werden auf den Servern dieses Dienstleisters gespeichert. Hierbei kann es sich
              insbesondere um IP-Adressen, Kontaktanfragen, Meta- und Kommunikationsdaten, Vertragsdaten, Kontaktdaten,
              Namen, Websitezugriffe und sonstige Daten, die über eine Website generiert werden, handeln.
            </p>
            <p className="mb-4">
              Das Hosting erfolgt zum Zwecke der Vertragserfüllung gegenüber unseren potenziellen und bestehenden Kunden
              (Art. 6 Abs. 1 lit. b DSGVO) und im Interesse einer sicheren, schnellen und effizienten Bereitstellung unseres
              Online-Angebots (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt
              die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die
            ...
            <p className="mb-4">
              Sollte der Inhalt oder die Gestaltung dieser Website Rechte Dritter oder gesetzliche Bestimmungen verletzen,
              bitten wir um eine entsprechende Nachricht ohne Kostennote. Wir sichern zu, die zu Recht beanstandeten
              Passagen unverzüglich zu prüfen und ggf. zu entfernen bzw. anzupassen, ohne dass die Einschaltung eines
              Rechtsbeistands von Ihrer Seite erforderlich ist.
            </p>
            <p className="mb-4">
              Kosten, die ohne vorherige Kontaktaufnahme mit uns ausgelöst werden, werden im Sinne der Schadensminderungspflicht
              als unbegründet zurückgewiesen. Wir behalten uns vor, gegebenenfalls Gegenmaßnahmen zu ergreifen, falls dennoch
              eine kostenpflichtige Abmahnung ohne vorherige Kontaktaufnahme erfolgt.
            </p>

            <div className="mt-12 pt-8 border-t-2" style={{ borderColor: 'rgba(148, 163, 184, 0.45)' }}>
